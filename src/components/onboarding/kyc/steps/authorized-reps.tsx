      ...
      {reps.map((rep, idx) => (
        <div key={idx} className="border border-gray-200 rounded-lg p-6 space-y-4">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-gray-900">{t("representativeTitle", { n: idx + 1 })}</h3>
            {reps.length > 1 && (
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">{t("jobTitleLabel")}</label>
            <Input
              type="text"
