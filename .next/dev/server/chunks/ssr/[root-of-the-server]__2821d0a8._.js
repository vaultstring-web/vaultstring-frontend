...
const GATEWAY = ("TURBOPACK compile-time value", "http://localhost:9000") || '';
...
async function apiFetch(path, init = {}) {
    ...
    if (!res.ok) {
        const err = new Error(data?.message || res.statusText || 'API request failed');
...
;
const USE_MOCK = !("TURBOPACK compile-time value", "http://localhost:9000");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2821d0a8._.js.map